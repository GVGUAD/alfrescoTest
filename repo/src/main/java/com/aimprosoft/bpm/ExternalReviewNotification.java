...
public class ExternalReviewNotification implements TaskListener {
    ...
    private static final String RECIP_PROCESS_VARIABLE = "vhwf_reviewerEmail";

    private static final Log logger = LogFactory.getLog(ExternalReviewNotification.class);
    ...
    public String getLink(String taskId, String outcome) {
        StringBuffer sb = new StringBuffer();
        sb.append("\r\n");
        sb.append("http://localhost:8080/alfresco/service/vh/review?id=activiti$");
        sb.append(taskId);
        sb.append("&action=");
        sb.append(outcome);
